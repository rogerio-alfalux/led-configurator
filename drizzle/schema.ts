...
export const users = mysqlTable("users", {
	...
	role: mysqlEnum(['user','admin','gerente','vendedor','assistente','convidado','custos']).default('user').notNull(),
...
export const invites = mysqlTable("invites", {
	...
	role: mysqlEnum(['user','convidado','vendedor','assistente','gerente','custos']).default('convidado').notNull(),
	message: text(),
	invitedByUserId: int(),
